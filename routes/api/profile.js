...
//@desc   delete profile by users & posts
//@access Private
router.delete('/', auth, async (req, res) => {
    try {
        ...
        await post.deleteMany({ user: re.id });
        //Remove profile
...
router.get('/github/:username', (req, res) => {
    try {
        ...
        const options = {
            ...
            sort=created:asc&client_id=${config.get('githubClientId')}&client_secrect=${config.get('githubSecret')}`,
            method: 'GET',
